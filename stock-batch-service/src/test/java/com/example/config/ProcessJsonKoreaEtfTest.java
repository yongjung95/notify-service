...
@SpringBootTest
@ActiveProfiles("test")
public class ProcessJsonKoreaEtfTest {

    @Autowired
    private JobRepository jobRepository;

    @Autowired
    private Step processJsonKoreaEtfStep;

    @Test
    void processJsonKoreaEtfStep_성공_테스트() throws Exception {
        // given
        ...
        // StepExecution 생성
        StepExecution stepExecution = new StepExecution("processJsonKoreaEtfStep", jobExecution);
        ...
        // when
        processJsonKoreaEtfStep.execute(stepExecution);
