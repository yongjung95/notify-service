...
@SpringBootTest
@ActiveProfiles("test")
class DownloadJsonAmericaEtfStepTest {

    @Autowired
    private JobRepository jobRepository;

    @Autowired
    private Step downloadJsonAmericaEtfStep;

    @Test
    void downloadJsonAmericaEtfStep_성공_테스트() throws Exception {
        ...
        // StepExecution 생성
        StepExecution stepExecution = new StepExecution("downloadJsonAmericaEtfStep", jobExecution);

        jobRepository.add(stepExecution);

        // when
        downloadJsonAmericaEtfStep.execute(stepExecution);
