...
public class KoreaStockJsonObjectReader implements JsonObjectReader<KoreaStockDTO> {

    private ObjectMapper objectMapper;
    private Iterator<KoreaStockDTO> dataIterator;

    public KoreaStockJsonObjectReader() {
    ...
    @Override
    public KoreaStockDTO read() throws Exception {
    ...
    public static class MyJsonDataWrapper {
        ...
        private List<KoreaStockDTO> outBlock1;
